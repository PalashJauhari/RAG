...
fields = [
    ...
    "orchestrator_model", "information_evaluator_model", "final_answer_model",
    "query_decomposition_model", "query_expansion_model",
    ...
    "graph_recursion_limit", "graph_max_concurrency", "information_evaluation_max_retries",
