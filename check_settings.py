...
fields = [
    ...
    "information_evaluator_model", "final_answer_model", "query_decomposition_model",
    ...
    "graph_recursion_limit", "graph_max_concurrency", "insufficient_recall_max_retries",
    "intent_mismatch_max_retries",
