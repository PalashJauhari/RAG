...
``recall_check`` updates verification on the same ``facts`` list and logs unsupported rows plus
the full accumulated ``retrieved_documents`` used for the decision. ``gap_fill`` logs repair
